<template>
	<div class="container-sidebar">
		<sidebar-menu :menu="menu" v-model:collapsed="collapsed" :disableHover="disableHover"/>
	</div>
</template>
...
<script>
	export default {
		data() {
			return {
				menu: [
					{ header: 'Sailing Log', hiddenOnCollapse: true, },
					{
						href: '/dashboard',
						title: 'Dashboard',
					...
					{ header: 'Account Info', hiddenOnCollapse: true, },
					{
						href: '/account',
						title: 'My account',
						disabled: true,
