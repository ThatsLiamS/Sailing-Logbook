...
We thrive off of the contributions and input from users. There are several ways you can get involved.

We are happy to hear your feedback for the future of Files. Check the
[issues tab](https://github.com/ThatsLiamS/Sailing-Logbook/issues) to see if others have
...
all community interactions must abide by the [Code of Conduct](https://github.com/ThatsLiamS/Sailing-Logbook/blob/main/.github/CODE_OF_CONDUCT.md).

## Finding issues you can help with
Looking for something to work on?
Issues marked [``triage approved``](https://github.com/ThatsLiamS/Sailing-Logbook/issues?q=is%3Aopen+is%3Aissue+label%3A%22triage+approved%22)
are a good place to start.

You can also check the [``help wanted``](https://github.com/ThatsLiamS/Sailing-Logbook/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) tag to find 
...
* **DO NOT** submit a PR unless it is linked to an Issue marked 
   [`triage approved`](https://github.com/ThatsLiamS/Sailing-Logbook/issues?q=is%3Aopen+is%3Aissue+label%3A%22triage+approved%22). 
...
[past pull requests](https://github.com/ThatsLiamS/Sailing-Logbook/pulls?q=is%3Apr+is%3Aclosed) to see
